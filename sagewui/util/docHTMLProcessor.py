...
- :class:`sagenb.util.docHTMLProcessor.genericHTMLProcessor`:
  gathers all the common methods of the other two classes.

- :class:`sagenb.util.docHTMLProcessor.SphinxHTMLProcessor`:
  translates HTML file generated by Sphinx into a worksheet text file

- :class:`sagenb.util.docHTMLProcessor.docutilsHTMLProcessor`:
...
Process the output of docutils ``rst2html`` command::
    ...
    sage: from sagenb.util.docHTMLProcessor import (docutilsHTMLProcessor)
